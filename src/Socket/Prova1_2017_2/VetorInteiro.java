...
public class VetorInteiro implements Runnable {
	...
	public byte[] pares(byte[] vetor) {// retorna um vetor com numeros pares
		...
		System.arraycopy(pares, 0, trim, 0, cont);// copia para o trim o novo vetor q só tenha a quantidade, pois pode
													// vir zeros
		return trim;
	}
